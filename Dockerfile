...
# Copiar la carpeta .streamlit si existe (para config.toml)
...
# Exponer el puerto que Render usa (8080 es el default, pero Streamlit por defecto usa 8501)
# Render lee la variable PORT del entorno automáticamente
EXPOSE 8080
